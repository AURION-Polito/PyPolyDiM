...
def assemble(geometry_utilities_confi: gedim.GeometryUtilitiesConfig,
    ...
    result = EllipticMCC2DProblemData()
    ...
    for c in range(mesh.cell2_d_total_number()):
        ...
        local_to_global_data = assembler_utilities.LocalMatrixToGlobalMatrixDOFsData(do_fs_data_indices,
                                                                                     local_count_do_fs.offset_do_fs,
                                                                                     count_do_fs_data.offset_do_fs,
                                                                                     count_do_fs_data.offset_strongs)
        ...
        compute_strong_term(c, mesh, mesh_do_fs_info[0], do_fs_data[0], reference_element_data, local_space_data,
                            test, result)
        compute_weak_term(c, mesh, mesh_do_fs_info[0], do_fs_data[0], reference_element_data,
